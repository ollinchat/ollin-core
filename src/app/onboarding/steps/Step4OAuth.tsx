  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-semibold text-gray-900 text-center">
        {t(locale, "onboarding.oauth.title")}
      </h1>
      <p className="text-gray-600 text-center text-sm">
        {t(locale, "onboarding.oauth.subtitle")}
      </p>
      <div className="space-y-3">
        ...
        >
          ...
          {t(locale, "onboarding.oauth.google")}
        </Button>
        <Button
          fullWidth
          variant="ghost"
        ...
        >
          ...
          {t(locale, "onboarding.oauth.email")}
        </Button>
      </div>
      <Button fullWidth variant="ghost" onClick={onSkip}>
        {t(locale, "onboarding.oauth.skip")}
      </Button>
    </div>
  );
}
